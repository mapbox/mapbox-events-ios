...
NSString * const MMEEventKeyLocationsForeground = @"locationsFG";
NSString * const MMEEventKeyLocationsBackground = @"locationsBG";
NSString * const MMEEventKeyLocationsWithApproximateValues = @"locationsAX";
NSString * const MMEEventKeyLocationsDroppedBecauseOfHAF = @"locationsHF";
NSString * const MMEEventKeyLocationsDroppedDueTimeout = @"locationsTO";
NSString * const MMEEventKeyLocationsConvertedIntoEvents = @"locationsTX";
