...
+ (TrustKit *)trustKitWithUpdatedConfiguration {
    ...
    //TODO: add to local storage, check if exists, request blacklist, remove blacklisted pins and (add any new keys to persistent blacklist?)
    NSArray *CNHashes = @[
