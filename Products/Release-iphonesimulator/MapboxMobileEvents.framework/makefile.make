...
ifeq ($(DEVICE_ID),)
	...
	xcodebuild -project $(MMETestHost_XPROJ) -scheme MMETestHost-leaks -sdk iphonesimulator12.2 -configuration Release -only-testing:MMETestHostUITests BUILD_DIR=$(BUILD_DIR)
endif
