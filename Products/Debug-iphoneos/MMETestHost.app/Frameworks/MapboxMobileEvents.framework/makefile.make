...
MOBILE_METRICS_XPROJ := $(CURRENT_DIR)/MapboxMobileEvents.xcodeproj
MOBILE_METRICS_APP := $(BUILD_DIR)/MMETestHost.app
//MOBILE_METRICS_UI_TEST_RUNNER_APP := $(BUILD_DIR)/Release-iphoneos/MobileMetricsUITests-Runner.app
...
ifeq ($(DEVICE_ID),)
	...
	xcodebuild -project $(MOBILE_METRICS_XPROJ) -scheme MMETestHost-leaks -sdk iphoneos 'platform=ios,id=$(DEVICE_ID)' BUILD_DIR=$(BUILD_DIR)
endif
